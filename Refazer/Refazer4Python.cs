...
namespace Refazer.Core
{
    ...
    public class Refazer4Python : Refazer
    {
        ...
        public Refazer4Python(string pathToGrammar = @"..\..\synthesis\", string pathToDslLib = @"bin/Debug")
        {
        ...
        public State CreateInputState(string program)
        {
            ...
            var input = State.CreateForLearning(Grammar.Value.InputSymbol, astBefore);
            return input;
        }
